...
enum PacketType // the second byte of any packet is one of these
{
	ISP_NONE,		//  0					: not used
...
enum TinyType// the fourth byte of an IS_TINY packet is one of these
{
...
enum SmallType// the fourth byte of an IS_SMALL packet is one of these
{
...
enum TTCType// the fourth byte of an IS_TTC packet is one of these
{
	TTC_NONE,		//  0					: not used
